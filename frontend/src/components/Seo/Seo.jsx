...
const SITE_URL = 'https://beachvolleypro.ru/'
...
const SEO_CONFIG = {
  ...
  '/camp2025': {
    title: 'Лагерь пляжного волейбола Сочи | Пляжный волейбол на побережье Турции',
    description: 'Лагерь пляжного волейбола в Сочи и на побережье Турции. Тренировочный лагерь пляжного волейбола с чемпионом России. Даты, цены, запись.',
    keywords: 'лагерь пляжного волейбола, лагерь пляжного волейбола сочи, пляжный волейбол, пляжный волейбол сочи',
  },
  '/training': {
    title: 'Пляжный волейбол Сочи | Тренер | Групповые и индивидуальные занятия',
  ...
  '/coach': {
    title: 'Пляжный волейбол Сочи | Тренер | Альберт Строев — чемпион России ',
